...
public class InventorySampleController {
    ...
    public  InventorySample addSInventorySample(@RequestBody InventorySample inventorySample){return inventorySampleService.addSInventorySample(inventorySample);}
    @PutMapping(value = "/inventorySample")
    public InventorySample updateInventorySample(@RequestBody Long id, InventorySample inventorySample){return inventorySampleService.updateInventorySample(id, inventorySample);}
